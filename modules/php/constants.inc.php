...
const EXPANSION19xx_OPTION = 101;
const LEGENDARY_CHARACTERS_EXPANSION_OPTION = 105;
...
const ST_PLAYER_CHOOSE_LEGENDARY_CHARACTER = 5;
...
const REMAINING_BULLET_TRAINS = 'REMAINING_BULLET_TRAINS';
