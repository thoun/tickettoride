...
function getRoutes() {
  return [
    1 => new Route(1, 8, YELLOW, [
        new RouteSpace(215, 1849, 25),
        new RouteSpace(268, 1874, 25),
        new RouteSpace(322, 1900, 25),
    ]),
    ...
    11 => new Route(2, 32, GRAY, [
        new RouteSpace(816, 805, -48),
        new RouteSpace(856, 758, -50),
        new RouteSpace(892, 710, -55),
        new RouteSpace(926, 660, -58),
    ...
    29 => new Route(5, 20, RED, [
        new RouteSpace(554, 467, 58),
        new RouteSpace(586, 518, 58),
    ]),
    30 => new Route(5, 20, GREEN, [
        new RouteSpace(535, 479, 58),
        new RouteSpace(566, 529, 58),
    ]),
    ...
    48 => new Route(8, 15, PINK, [
        new RouteSpace(455, 1859, -27),
        new RouteSpace(401, 1886, -27),
    ]),
    49 => new Route(8, 19, WHITE, [
        new RouteSpace(245, 1727, 57),
        new RouteSpace(279, 1779, 57),
        new RouteSpace(315, 1827, 57),
        new RouteSpace(349, 1873, 57),
    ]),
    50 => new Route(8, 28, ORANGE, [
        new RouteSpace(354, 1955, 97),
    ]),
    51 => new Route(9, 15, GRAY, [
        new RouteSpace(625, 1729, -32),
        new RouteSpace(576, 1766, -39),
        new RouteSpace(532, 1806, -44),
    ], ferryWaves: 1),
    52 => new Route(9, 15, GRAY, [
        new RouteSpace(636, 1750, -32),
        new RouteSpace(590, 1784, -39),
        new RouteSpace(547, 1823, -44),
    ], ferryWaves: 1),
    ...
    54 => new Route(9, 26, GREEN, [
        ...
        new RouteSpace(667, 1592, 84),
        new RouteSpace(674, 1650, 84),
    ]),
    ...
    60 => new Route(10, 23, PINK, [
        new RouteSpace(475, 625, 39),
    ]),
    61 => new Route(10, 23, RED, [
        new RouteSpace(462, 642, 39),
    ]),
    ...
    74 => new Route(12, 23, GREEN, [
        new RouteSpace(371, 449, 69),
        new RouteSpace(392, 501, 69),
        new RouteSpace(415, 557, 69),
    ]),
    ...
    88 => new Route(15, 28, GRAY, [
        new RouteSpace(481, 1887, -50),
        new RouteSpace(441, 1932, -45),
        new RouteSpace(398, 1970, -37),
    ], ferryWaves: 1),
    89 => new Route(15, 28, GRAY, [
        new RouteSpace(498, 1900, -50),
        new RouteSpace(456, 1949, -45),
        new RouteSpace(411, 1989, -37),
    ], ferryWaves: 1),
    ...
    94 => new Route(17, 19, GRAY, [
        new RouteSpace(518, 1365, -37),
        new RouteSpace(473, 1402, -40),
        new RouteSpace(427, 1441, -43),
        new RouteSpace(383, 1482, -46),
        new RouteSpace(343, 1527, -48),
        new RouteSpace(307, 1571, -50),
        new RouteSpace(269, 1619, -51),
    ], ferryWaves: 4),
    ...
    107 => new Route(21, 22, BLACK, [
        new RouteSpace(618, 891, 61),
        new RouteSpace(648, 943, 61),
        new RouteSpace(677, 996, 61),
        new RouteSpace(703, 1044, 61),
    ]),
    ...
    110 => new Route(22, 25, ORANGE, [
        new RouteSpace(550, 1048, 11),
        new RouteSpace(608, 1059, 10),
        new RouteSpace(666, 1068, 10),
    ]),
    ...
    125 => new Route(32, 5001, YELLOW, [
        new RouteSpace(996, 605, 79),
        new RouteSpace(1010, 664, 78),
    ]),
    126 => new Route(32, 5001, PINK, [
        new RouteSpace(1019, 600, 77),
        new RouteSpace(1031, 659, 78),
    ]),
