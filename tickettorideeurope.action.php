 ...
 * -----
 * 
 * tickettorideeurope.action.php
 *
 * TicketToRideEurope main action entry point
 *
 *
 ...
 * this.ajaxcall( "/tickettorideeurope/tickettorideeurope/myAction.html", ...)
 *
 */
  
  
  class action_tickettorideeurope extends APP_GameAction { 
    // Constructor: please do not modify
      ...
      if (self::isArg('notifwindow')) {
          ...
          $this->view = "tickettorideeurope_tickettorideeurope";
