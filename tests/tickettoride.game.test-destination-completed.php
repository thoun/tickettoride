...
require_once ('../tickettorideswitzerland.game.php');

class TicketToRideTestDestinationCompleted extends TicketToRideSwitzerland { // this is your game class defined in ggg.game.php
