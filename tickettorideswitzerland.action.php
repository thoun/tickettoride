 ...
 * -----
 * 
 * tickettorideswitzerland.action.php
 *
 * TicketToRideSwitzerland main action entry point
 *
 *
 ...
 * this.ajaxcall( "/tickettorideswitzerland/tickettorideswitzerland/myAction.html", ...)
 *
 */
  
  
  class action_tickettorideswitzerland extends APP_GameAction { 
    // Constructor: please do not modify
      ...
      if (self::isArg('notifwindow')) {
          ...
          $this->view = "tickettorideswitzerland_tickettorideswitzerland";
